...
require (
	...
	k8s.io/apiextensions-apiserver v1.36.3 // indirect
	k8s.io/apiserver v0.36.3 // indirect
	k8s.io/cloud-provider v1.36.3 // indirect
	...
	sigs.k8s.io/apiserver-network-proxy/konnectivity-client v0.36.3 // indirect
